...
# ** MvImport가 있는 폴더 위치를 import해야함. **
sys.path.append("C:/Users/AnSunHwan/Desktop/Ace/Vision/HIKvsion/MvImport")
...
def Reformat_Image(image):
    ...
    width = int(width/3.825)
    height = int(height/4.2625)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        numArray = Reformat_Image(numArray)
