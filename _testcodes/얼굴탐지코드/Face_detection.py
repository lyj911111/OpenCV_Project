...
# haarcascade_frontalface_default.xml 을 불러와야 함. (opencv에서 기본으로 제공) - 파일경로 입력.
face_cascade = cv2.CascadeClassifier()
face_cascade.load('C:/Users/Lee Won Jae/PycharmProjects/_virtualenv/pyQT_Test/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
