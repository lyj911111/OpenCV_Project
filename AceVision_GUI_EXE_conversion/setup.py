...
optimization = 0
resources = ["QR_SS_Detect/QR_SS_Detect.py", "RivetDetect/RivetDetect.py"]                                                                                    # main.py에 내가 import한 경로와 모듈 (폴더/모듈.py)
packages = ["numpy", "imutils", "cv2", "more_itertools","Image","decode","PIL", "math", "datetime", "time", "os", "tkinter", "pyzbar","pylibdmtx.pylibdmtx"]  # 내부에 있는 모든 import한 모듈들... 총집합
